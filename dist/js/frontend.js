...
function sbgFormatMoney(number, places, symbol, thousand, decimal) {
  ...
  var negative = number < 0 ? '-' : '',
      i = _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_4___default()(number = Math.abs(+number || 0).toFixed(places), 10) + '',
      j = 0;
  ...
  return symbol + negative + (j ? i.substr(0, j) + thousand : '') + i.substr(j).replace(/(\d{3})(?=\d)/g, '$1' + thousand) + (places ? decimal + _babel_runtime_corejs3_core_js_stable_instance_slice__WEBPACK_IMPORTED_MODULE_5___default()(_context = Math.abs(number - i).toFixed(places)).call(_context, 2) : '');
  /* eslint-enable */
}
...
function wbpoFormatPrice(price) {
  ...
  var priceHtml = '<span class="woocommerce-Price-amount amount">';
  var priceFormatted = sbgFormatMoney(price, WbPo.price_decimals, '', WbPo.price_thousand_separator, WbPo.price_decimal_separator);

  switch (WbPo.price_format) {
    case '%1$s%2$s':
      // left.
      priceHtml += _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_6___default()(_context2 = "<span class=\"woocommerce-Price-currencySymbol\"> ".concat(WbPo.currency_symbol, "</span> ")).call(_context2, priceFormatted);
      break;

    case '%1$s %2$s':
      // Left with space
      priceHtml += _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_6___default()(_context3 = "<span class=\"woocommerce-Price-currencySymbol\"> ".concat(WbPo.currency_symbol, "</span> ")).call(_context3, priceFormatted);
      break;

    case '%2$s%1$s':
      // right
      priceHtml += _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_6___default()(_context4 = " ".concat(priceFormatted, "<span class=\"woocommerce-Price-currencySymbol\">")).call(_context4, WbPo.currency_symbol, "</span>");
      break;

    case '%2$s %1$s':
      // right with space
      priceHtml += _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_6___default()(_context5 = "".concat(priceFormatted, "<span class=\"woocommerce-Price-currencySymbol\">")).call(_context5, WbPo.currency_symbol, "</span>");
      break;

    default:
      // default
      priceHtml += _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_6___default()(_context6 = "<span class=\"woocommerce-Price-currencySymbol\"> ".concat(WbPo.currency_symbol, "</span> ")).call(_context6, priceFormatted);
  }
...
function wbpoCalcPrice(wrap) {
  ...
  var total = 0;
  var products = wrap.querySelector('.wbpo-products');
  var totalWrapper = wrap.querySelector('.wbpo-total');

  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context7 = products.querySelectorAll('.wbpo-product')).call(_context7, function (product) {
    if (product.dataset.price > 0 && product.dataset.qty > 0) {
      total += product.dataset.price * product.dataset.qty;
    }
  });

  var totalHtml = wbpoFormatPrice(total);
  totalWrapper.innerHTML = _babel_runtime_corejs3_core_js_stable_instance_concat__WEBPACK_IMPORTED_MODULE_6___default()(_context8 = "".concat(WbPo.total_text, " : ")).call(_context8, totalHtml);
  ...
  var event = new Event('wbpo_calc_price');
...
function wbpoSaveIds(wrap) {
  ...
  var ids = [];
  var products = wrap.querySelector('.wbpo-products');
  var currentGroup = wrap.querySelector('.wbpo-current-group');

  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context9 = products.querySelectorAll('.wbpo-product')).call(_context9, function (product) {
    if (product.dataset.id > 0 && product.dataset.qty > 0) {
      ids.push({
        id: product.dataset.id,
        qty: product.dataset.qty
      });
    }
  });

  currentGroup.value = _babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_8___default()(ids);
}
...
function wbpoInit(wrap) {
  ...
  var isEmpty = true;
  var products = wrap.querySelector('.wbpo-products');
  var btn = wrap.querySelector('.single_add_to_cart_button');

  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context10 = products.querySelectorAll('.wbpo-product')).call(_context10, function (product) {
    if (product.dataset.qty > 0 && _babel_runtime_corejs3_core_js_stable_parse_int__WEBPACK_IMPORTED_MODULE_4___default()(product.dataset.id, 10) === 0) {
      isSelection = true;
    }
...
function productSelectionChecked(product) {
  var selectionType = product.dataset.selectionType;

  if (selectionType === 'radio') {
    product.addEventListener('click', function (e) {
      var _context11;

      _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context11 = document.querySelectorAll('.wbpo-product')).call(_context11, function (_product) {
      ...
      e.target.closest('.wbpo-product').querySelector('input[type="radio"]').dispatchEvent(new Event('change'));
    });
  }
  ...
  if (selectionType === 'checkbox') {
    product.addEventListener('click', function (e) {
      ...
      var checkBox = e.target.closest('.wbpo-product').querySelector('input[type="checkbox"]');

      if (e.target.closest('.wbpo-products').classList.contains('classic') && e.target === e.target.closest('.checkmark')) {
...
document.addEventListener('DOMContentLoaded', function () {
  var _context12, _context14, _context16, _context17;

  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context12 = document.querySelectorAll('.product-type-wbpo')).call(_context12, function (wrap) {
    if (wrap.querySelectorAll('.wbpo-product').length) {
      var _context13;

      wbpoInit(wrap);

      _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context13 = wrap.querySelectorAll('.wbpo-product')).call(_context13, function (product) {
  ...
  document.addEventListener('wbpo_found_variation', function (e) {
    var wrap = e.originalTarget.closest('.product-type-wbpo');
    var data = e.data;
    var product = e.originalTarget.closest('.wbpo-product');
    ...
    if (product) {
      ...
      if (data.image.url && data.image.srcset) {
        // change image
        var thumbImage = product.querySelector('.wbpo-thumb img');
      ...
      if (data.variation_description !== '' && product.querySelector('.wbpo-variation-description')) {
        product.querySelector('.wbpo-variation-description').innerHTML = data.variation_description;
      ...
      if (WbPo.change_image === 'off') {
        ...
        e.originalTarget.closest('.variations_form').dispatchEvent(new Event('reset_image'));
      }
  ...
  document.addEventListener('wbpo_reset_data', function (e) {
    var wrap = e.originalTarget.closest('.product-type-wbpo');
    var product = e.originalTarget.closest('.wbpo-product');
    ...
    if (product) {
      ...
      if (product.querySelector('.wbpo-thumb img')) {
        product.querySelector('.wbpo-thumb img').src = product.querySelector('.wbpo-thumb').dataset.thumb;
        product.querySelector('.wbpo-thumb img').srcset = '';
      } // reset price


      if (product.querySelector('.wbpo-price')) {
        product.querySelector('.wbpo-price').innerHTML = product.querySelector('.wbpo-price').dataset.priceHtml;
      } // reset availability
  ...
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context14 = document.querySelectorAll('.wbpo-qty-mod')).call(_context14, function (btn) {
    btn.addEventListener('click', function (e) {
      var qtyWrapper = e.target.parentElement;
      var qty = qtyWrapper.querySelector('.qty');
      var val = qty.value || 0;
      var min = qty.attributes.min.value || 0;
      var max = qty.attributes.max.value || 0;
      var step = qty.attributes.step.value || 1;
      val = _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_9___default()(val);
      min = _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_9___default()(min);
      max = _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_9___default()(max);
      step = _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_9___default()(step);
  ...
  if (document.querySelector('.qty')) {
    ...
    _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context15 = document.querySelectorAll('.qty')).call(_context15, function (input) {
      input.addEventListener('change', function (e) {
        var qtyWrapper = e.target.parentElement;
        var wrap = e.target.closest('.product-type-wbpo');
        var qtyInput = e.target;
        var qty = qtyInput.value || 0;
        var min = qtyWrapper.dataset.min || 0;
        var max = qtyWrapper.dataset.min || 0;
        qty = _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_9___default()(qty);
        min = _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_9___default()(min);
        max = _babel_runtime_corejs3_core_js_stable_parse_float__WEBPACK_IMPORTED_MODULE_9___default()(max);
  ...
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context16 = document.querySelectorAll('.wbpo-checkbox')).call(_context16, function (checkbox) {
    checkbox.addEventListener('change', function (e) {
      var checkBox = e.target;
      var wrap = checkBox.closest('.product-type-wbpo');
  ...
  _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context17 = document.querySelectorAll('.wbpo-radio')).call(_context17, function (radioBtn) {
    radioBtn.addEventListener('change', function (e) {
      var _context18;

      var radioBtn = e.target;
      var wrap = radioBtn.closest('.product-type-wbpo');

      if (radioBtn.checked) {
        radioBtn.closest('.wbpo-product').setAttribute('data-qty', 1);
      }

      _babel_runtime_corejs3_core_js_stable_instance_for_each__WEBPACK_IMPORTED_MODULE_7___default()(_context18 = document.querySelectorAll('.wbpo-radio')).call(_context18, function (_radioBtn) {
...
jQuery(document).on('found_variation', function (e, data) {
  var event = new Event('wbpo_found_variation');
  event.data = data;
...
jQuery(document).on('reset_data', function (e) {
  var event = new Event('wbpo_reset_data');
  event.originalTarget = e.target;
  document.dispatchEvent(event);
});
}();
